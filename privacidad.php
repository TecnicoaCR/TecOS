...
<html>
	...
	<title>Política de privacidad | TecnicoaCR</title>
		
	<!-- Metatags
	================================================== -->
	<meta name="description" content="Política de privacidad de TecnicoaCR" />
	<meta name="keywords" content="politica,privacidad,TecnicoCR,costa rica" />
	<meta property="og:title" content="Política de privacidad | TecnicoaCR | Costa Rica" />
	<meta property="og:description" content="Política de privacidad de TecnicoaCR" />
	<meta property="og:type" content="website" />
	<meta property="og:locale" content="es" />
	<meta property="og:url" content="index.php" />
	<meta property="og:site_name" content="TecnicoaCR" />
	<meta name="geo.region" content="Costa Rica" />
	<meta name="geo.placename" content="Guanacste" />
	...
	<main>
		...
		<div class="container section-b text-justify">
			...
			<p>Esta página le informa de nuestras políticas en materia de recopilación, uso y divulgación de datos personales cuando utiliza nuestro Servicio y de las opciones de las que dispone en relación con esos datos.</p>
                        ...
                        <p>Utilizamos sus datos para prestarle el Servicio y mejorarlo. Al utilizar el Servicio, usted acepta la recopilación y el uso de información de conformidad con esta política. A menos que esta Política de privacidad defina lo contrario, los términos utilizados en ella tienen los mismos significados que nuestros <a href="condiciones.php">Términos y Condiciones</a>.</p>
			
			<h2 class="pt-4 pb-2">Definiciones</h2>
			<ul>
				<li>
					<p><strong>Servicio</strong></p>
                                        <p>Servicio es el sitio web <a href="index.php">www.tecnicoacr.com</a> operado por TecnicoaCR</p>
				</li>
				<li>
			...
			<h2 class="pt-4 pb-2">Recopilación y uso de la información</h2>
			<p>Recopilamos diferentes tipos de información con diversas finalidades para prestarle el
			Servicio y mejorarlo.</p>
			
			<h3 class="py-2">Tipos de datos recopilados</h3>
			
			<h4 class="pb-2">Datos personales</h4>
			...
			<h4 class="pb-2">Datos de cookies y seguimiento</h4>
			...
			<h2 class="pt-4 pb-2">Uso de datos</h2> 
			<p>TecnicoaCR utiliza los datos recopilados con diversas finalidades:</p>    
			<ul>
			...
			<h2 class="pt-4 pb-2">Transferencia de datos</h2>
			...
			<p>Si usted se encuentra fuera de Costa Rica y decide facilitarnos información, tenga en cuenta que nosotros transferimos los datos, incluyendo Datos personales, a Costa Rica y que los tratamos allí.</p>
			...
			<p>misChunches emprenderá todas las medidas razonables necesarias para garantizar que sus datos sean tratados de forma segura y de conformidad con esta Política de privacidad y no se realizará ninguna transferencia de sus Datos personales a una organización o país, salvo que existan unos controles adecuados establecidos incluyendo la seguridad de sus datos y otra información personal.</p>
			
			<h2 class="pt-4 pb-2">Divulgación de datos</h2>
			
			<h3 class="py-2">Requisitos legales</h3>
			<p>TecnicoaCR puede divulgar sus Datos personales de buena fe cuando considere que esta acción es necesaria para lo siguiente:</p>
			<ul>
				<li>Cumplir una obligación legal</li>
				<li>Proteger y defender los derechos o bienes de TecnicoaCR</li>
			...
			<h2 class="pt-4 pb-2">Seguridad de los datos</h2>
			...
			<h2 class="pt-4 pb-2">Proveedores de servicios</h2>
			...
			<h2 class="pt-4 pb-2">Enlaces a otros sitios</h2>
			...
			<h2 class="pt-4 pb-2">Privacidad del menor</h2>
			...
			<h2 class="pt-4 pb-2">Cambios en esta Política de Privacidad</h2>
			<p>Podemos actualizar nuestra Política de privacidad periódicamente.</p>
			...
			<h2 class="pt-4 pb-2">Información de contacto</h2>
			<p>Si tiene alguna pregunta sobre esta Política de privacidad, contacte con nosotros: </p>
			<ul>
				<li>Por e-mail: <a href="mailto:info@tecnicoacr.com">info@tecnicoacr.com</a></li>	
				<li>Por teléfono: +506-8739-7420</li>				  
			</ul>		
		</div>
	</main>
