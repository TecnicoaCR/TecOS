...
<html lang="es">
  ...
  <section class="bg-dark text-white">
      <h2 class="mb-3 text-center">Nuestras aplicaciones!</h2>
      ...
      <div class="row">
        <div class="col-lg-3 col-md-6 text-center">
          <div class="service-box mt-5 mx-auto">
            <i class="fas fa-4x fa-paper-plane text-primary mb-3 sr-icon-2"></i>
            <h3 class="mb-3">TecOS_MyCCTV!</h3>
            <p class="text-muted mb-0"> El sistema web de integración CCTV</p>
            <a class="btn btn-light btn-xl sr-button" href="apps/MyCCTV/index.php">Ingresar ahora!</a>
          </div>
        </div>
        <div class="col-lg-3 col-md-6 text-center">
          <div class="service-box mt-5 mx-auto">
            <i class="fas fa-4x fa-paper-plane text-primary mb-3 sr-icon-2"></i>
            <h3 class="mb-3">TecOS_INV!</h3>
            <p class="text-muted mb-0"> Sistema web de Inventario Avanzado</p>
        ...
        <div class="col-lg-3 col-md-6 text-center">
          <div class="service-box mt-5 mx-auto">
            <i class="fas fa-4x fa-code text-primary mb-3 sr-icon-3"></i>
            <h3 class="mb-3">TecOS_CERT!</h3>
            <p class="text-muted mb-0"> Aplicación web de Certificación Digital</p>
            <a class="btn btn-light btn-xl sr-button" href="apps/CERT/index.php">Ingrese ahora!</a>
          </div>
        </div>
        <div class="col-lg-3 col-md-6 text-center">
          <div class="service-box mt-5 mx-auto">
            <i class="fas fa-4x fa-heart text-primary mb-3 sr-icon-4"></i>
            <h3 class="mb-3">TecOS_MONEY</h3>
            <p class="text-muted mb-0">Sistema web de Facturación</p>
            <a class="btn btn-light btn-xl sr-button" href="apps/MONEY/index.php">Ingrese ahora!</a>
          </div>
        </div>
      </div>
    </div>
