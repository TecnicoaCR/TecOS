...
<html>
	...
	<title>Plan PLUS | TecnicoaCR</title>
                    ...
                    <div class="hero-message">
                        <div class="row">
                            <div class="col-md-12 col-lg-7 pr-5">
                                <h1>Plan de Desarrollo Web <span class="plus">PLUS<i class="fal fa-code fa-fw plus"></i></span></h1>
                                <p>Sitio web de 10 páginas dinámicas, ideal para empresas e instituciones que deseen aumentar su oferta de servicios y productos.</p>
                                <div id="more">
                                    <a class="btn-cta btn-cta-orange" style="background: darkorchid" href="#next"><i class="fal fa-chevron-circle-down"></i> Ver Plan PLUS <i class="fal fa-code fa-fw"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container section-b" id="content">
                <div class="row">
                    <div class="d-none d-lg-block col-3">
                        ...
                        ================================================== -->
                        <nav class="sticky">
                            <h2><i class="fal fa-list plus"></i> Menú</h2>
                            <ul class="sidebarList mb-5" id="sidebar">
                                <li><a href="#descripcion"><i class="fal fa-comments fa-fw plus"></i> Descripción</a></li>
                                <li><a href="#caracteristicas"><i class="fal fa-clipboard-list-check fa-fw plus"></i> Características</a></li>
                                <li><a href="#inversion"><i class="fal fa-file-invoice-dollar fa-fw plus"></i> Condiciones de pago</a></li>
                                <li><a href="#pago"><i class="fal fa-money-check-alt fa-fw plus"></i> Métodos de de pago</a></li>
                                <li><a href="#dominio"><i class="fal fa-globe-americas fa-fw plus"></i> Disponibilidad de dominio</a></li>
                                <!--<li><a href="#comprar"><i class="fal fa-shopping-cart fa-fw"></i> Contratar plan</a></li>-->
                            </ul>
                            <h4 class="mt-5"><i class="fal fa-list plus"></i> Otros Planes</h4>
                    ...
                    <div class="col offset-0 pr-4">
                        <!-- descripcion -->
                       <div class="section-b">
                            <h2 class="pb-3" id="descripcion"><i class="fal fa-code fa-fw plus"></i>  <strong><span class="tecnicoa">Plan</span> <span class="plus">PLUS </span></strong></h2>
                                <div class="text-justify">
                                    <p>Este plan es de un sitio web de (10) páginas ideal para empresas medianas a grandes, Asociaciones Solidaristas e Instituciones que deseen ofrecer sus productos y/o servicios en Internet.</p>
                                    <p>Una distribución frecuente de las secciones de este plan es:</p>
                                </div>
                                <ol>
                                    <li>Página de inicio</li>
                                    <li>Información de la empresa</li>
                                    <li>Productos o servicios (varias páginas)</li>
                                    <li>Clientes o Galería de trabajos</li>
                                    <li>Página de contacto</li>
                                </ol>
                            </div>			
			<!-- caracteristicas -->
                        <div class="section-b">
                            <h2 class="pb-3" id="caracteristicas"><i class="fal fa-clipboard-list-check plus"></i> Características del <strong><span class="tecnicoa">Plan</span> <span class="plus">PLUS</span></strong></h2>
                            ...
                            <ul>
                                    ...
                                    <li>Registro de dominio gratuito (com .net .org .cr)</li>
                                    <li>Hospedaje web</li>
                                    ...
                                    <li>Posicionamiento del sitio con SEO Avanzado - optimización del motor de búsqueda</li>
                            </ul>

                            <h4>Características específicas</h4>
                            <ul>
                                    <li>10 páginas o secciones</li>
                                    <li>1 formulario de contacto</li>
                                    <li>4 actualizaciones mensuales del contenido (texto e imagenes)</li>
                                    <li>8 imagenes de alta definición gratuitas</li>
                                    <li>Tiempo de entrega: 22 - 30 días laborales</li>
                            </ul>
                        </div>
                        <!-- inversion -->
                        <div class="section-b">
                            <h2 class="pb-3" id="inversion"><i class="fal fa-file-invoice-dollar plus"></i> Condiciones de pago del <strong><span class="tecnicoa">Plan</span> <span class="plus">PLUS</span></strong></h2>
                            <div class="row pb-5">
                                <div class="col-sm-12 col-md-4 text-center">
                                    <div class="card shadow-pricing mb-4">
                                        <div class="card-header text-white bg-site-plus">Primer mensualidad</div>
                                        <div class="card-body plans-price">
                                            <p>US $72.99</p>
                                            <small>(₡ 43,794.88)</small>
                                        </div>
                                    </div>
                                </div>
                                <div class="col">
                                    <h5 class="mt-0">Inversión inicial:</h5>
                                    <p>La inversión inicial de <strong>US $72.99</strong> incluye todas las características indicadas para este plan. ¡No existe ningún otro costo oculto!</p>
                                    <h5 class="mt-4">Condiciones de pago:</h5>
                                    <ul>
                                        <li>Pago de contado: <strong>US $72.99</strong> para iniciar el proceso.</li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <!-- metodos de pago -->
                        <div class="section-b">
                            <h2 class="pb-3" id="pago"><i class="fal fa-money-check-alt plus"></i> Métodos de pago</h2>
                        ...
                        <!-- dominio -->
                        <div class="section-b">
                            <h2 class="pb-3" id="dominio"><i class="fal fa-globe-americas plus"></i> Nosotros nos encargamos de encontrar el nombre de dominio por usted</h2>
