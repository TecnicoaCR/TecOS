...
<html>
	...
	<title>Plan PRO | TecnicoaCR</title>
...
<body>
	...
	<main>
                    ...
                    <div class="hero-message">
                        <div class="row">
                            <div class="col-md-12 col-lg-7 pr-5">
                                <h1>Plan de Desarrollo Web <span class="pro">PRO <i class="fal fa-coffee fa-fw pro"></i></span></h1>
                                <p>Un sitio web con páginas dinámicas, ideal para PyMEs ya Servicios Profesionales que requieran de una mayor cantidd de información para sus clientes.</p>
                                <div id="more">
                                    <a class="btn-cta btn-cta-orange" style="background: crimson" href="#next"><i class="fal fa-chevron-circle-down"></i> Ver Plan PRO <i class="fal fa-coffee fa-fw"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container section-b" id="content">
                <div class="row">
                    <div class="d-none d-lg-block col-3">
                        ...
                        ================================================== -->
                        <nav class="sticky">
                            <h2><i class="fal fa-list pro"></i> Menú</h2>
                            <ul class="sidebarList mb-5" id="sidebar">
                                <li><a href="#descripcion"><i class="fal fa-comments fa-fw pro"></i> Descripción</a></li>
                                <li><a href="#caracteristicas"><i class="fal fa-clipboard-list-check fa-fw pro"></i> Características</a></li>
                                <li><a href="#inversion"><i class="fal fa-file-invoice-dollar fa-fw pro"></i> Condiciones de pago</a></li>
                                <li><a href="#pago"><i class="fal fa-money-check-alt fa-fw pro"></i> Métodos de de pago</a></li>
                                <li><a href="#dominio"><i class="fal fa-globe-americas fa-fw pro"></i> Disponibilidad de dominio</a></li>
                                <!--<li><a href="#comprar"><i class="fal fa-shopping-cart fa-fw"></i> Contratar plan</a></li>-->
                            </ul>
                            <h4 class="mt-5"><i class="fal fa-list pro"></i> Otros Planes</h4>
                            <ul class="sidebarList">
                                <li><a href="../dev_pyme/"><i class="fal fa-coffee fa-fw pyme"></i> PYME</a></li>
                    ...
                    <div class="col offset-0 pr-4">
                        <!-- descripcion -->
                       <div class="section-b">
                            <h2 class="pb-3" id="descripcion"><i class="fal fa-coffee fa-fw pro"></i>  <strong><span class="tecnicoa">Plan</span> <span class="pro">PRO</span></strong></h2>
                                <div class="text-justify">
                                    <p>Este plan es de un sitio web con páginas dinámicas ideal para PyMES, Asociaciones Solidaristas, Bufetes de Abogados e Instituciones que deseen ofrecer sus productos y/o servicios en Internet.</p>
			...
			<!-- caracteristicas -->
                        <div class="section-b">
                            <h2 class="pb-3" id="caracteristicas"><i class="fal fa-clipboard-list-check pro"></i> Características del <strong><span class="tecnicoa">Plan</span> <span class="pro">PRO</span></strong></h2>
                            ...
                            <ul>
                                    <li>5 páginas o secciones</li>
                                    <li>1 formulario de contacto</li>
                                    <li>2 actualizaciones mensuales del contenido (texto e imagenes)</li>
                                    <li>4 imagenes de alta definición gratuitas</li>
                                    <li>Tiempo de entrega: 15 - 22 días laborales</li>
                            </ul>
                        </div>
                        <!-- inversion -->
                        <div class="section-b">
                            <h2 class="pb-3" id="inversion"><i class="fal fa-file-invoice-dollar pro"></i> Condiciones de pago del <strong><span class="tecnicoa">Plan</span> <span class="pro">PRO</span></strong></h2>
                            <div class="row pb-5">
                                <div class="col-sm-12 col-md-4 text-center">
                                    <div class="card shadow-pricing mb-4">
                                        <div class="card-header text-white bg-site-pro">Primer mensualidad</div>
                                        <div class="card-body plans-price">
                                            <p>US $44.99</p>
                                            <small>(₡ 26,994.88)</small>
                                        </div>
                                    </div>
                                </div>
                                <div class="col">
                                    <h5 class="mt-0">Inversión inicial:</h5>
                                    <p>La inversión inicial de <strong>US $44.99</strong> incluye todas las características indicadas para este plan. ¡No existe ningún otro costo oculto!</p>
                                    <h5 class="mt-4">Condiciones de pago:</h5>
                                    <ul>
                                        <li>Pago de contado: <strong>US $44.99</strong> para iniciar el proceso.</li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <!-- metodos de pago -->
                        <div class="section-b">
                            <h2 class="pb-3" id="pago"><i class="fal fa-money-check-alt pro"></i> Métodos de pago</h2>
                        ...
                        <!-- dominio -->
                        <div class="section-b">
                            <h2 class="pb-3" id="dominio"><i class="fal fa-globe-americas pro"></i> Nosotros nos encargamos de encontrar el nombre de dominio por usted</h2>
