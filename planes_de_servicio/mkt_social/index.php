...
<html>
	...
	<title>Plan SOCIAL | TecnicoaCR</title>
	...
	<meta property="og:url" content="../planes_de_servicio/dev_pro/" />
...
<body>
	...
	================================================== -->
	<header id="header">	
            <?php include_once '../../assets/nav_2.php';?>
	</header>
                    ...
                    <div class="hero-message">
                        <div class="row">
                            <div class="col-md-12 col-lg-7 pr-5">
                                <h1>Plan de Marketing <span class="social">SOCIAL <i class="fal fa-globe fa-fw social"></i></span></h1>
                                <p>Usa herramientas de marketing digital para impulsar tu empresa y obtener los mejores resultados. A través del uso de las redes sociales adecuadas, podrás fortalecer la relación con tus consumidores y saber cómo acercarte a ellos.</p>
                                <div id="more">
                                    <a class="btn-cta btn-cta-orange" style="background: #090" href="#next"><i class="fal fa-chevron-circle-down"></i> Ver Plan SOCIAL <i class="fal fa-globe fa-fw"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container section-b" id="content">
                <div class="row">
                    <div class="d-none d-lg-block col-3">
                        ...
                        ================================================== -->
                        <nav class="sticky">
                            <h2><i class="fal fa-list social"></i> Menú</h2>
                            <ul class="sidebarList mb-5" id="sidebar">
                                <li><a href="#descripcion"><i class="fal fa-comments fa-fw social"></i> Descripción</a></li>
                                <li><a href="#caracteristicas"><i class="fal fa-clipboard-list-check fa-fw social"></i> Características</a></li>
                                <li><a href="#inversion"><i class="fal fa-file-invoice-dollar fa-fw social"></i> Condiciones de pago</a></li>
                                <li><a href="#pago"><i class="fal fa-money-check-alt fa-fw social"></i> Métodos de de pago</a></li>
                            ...
                            <h4 class="mt-5"><i class="fal fa-list social"></i> Otros Planes</h4>
                            <ul class="sidebarList">
                                <li><a href="../dev_pyme/"><i class="fal fa-book fa-fw pyme"></i> PYME</a></li>
                                <li><a href="../dev_pro/"><i class="fal fa-coffee fa-fw pro"></i> PRO</a></li>
                                <li><a href="../mkt_social/"><i class="fal fa-globe fa-fw plus"></i> PLUS</a></li>
                            </ul>
                        </nav>
                    </div>
                    <div class="col offset-0 pr-4">
                        <!-- descripcion -->
                       <div class="section-b">
                            <h2 class="pb-3" id="descripcion"><i class="fal fa-globe fa-fw social"></i>  <strong><span class="tecnicoa">Plan</span> <span class="social">SOCIAL </span></strong></h2>
                                <div class="text-justify">
                                    <p>Usamos herramientas de marketing digital para impulsar tu empresa y obtener los mejores resultados. A través del uso de las redes sociales adecuadas, podrás fortalecer la relación con tus consumidores y saber cómo acercarte a ellos.</p>
                                    <p>Una distribución frecuente de las secciones de este plan es:</p>
                                </div>
                                <ol>
                                    <li>Perfil de Facebook</li>
                                    <li>Perfil de Instagram</li>
                                    <li>Perfil en Google</li>
                                    <li>Publicaciones en Facebook</li>
                                    <li>Publicidad en Facebook</li>
                                    <li>Rendimiento y Alcance</li>
                                </ol>
                            </div>			
			<!-- caracteristicas -->
                        <div class="section-b">
                            <h2 class="pb-3" id="caracteristicas"><i class="fal fa-clipboard-list-check social"></i> Características del <strong><span class="tecnicoa">Plan</span> <span class="social">SOCIAL</span></strong></h2>
                            <!-- Caracteristicas generales
                            ================================================== -->
                            <h4>Características generales</h4>
                            <ul>
                                
                                <li>Diseño de imagen de perfil y de portada</li>
                                <li>Actualización de información de contácto</li>
                                <li>Respuestas Automaticás</li>
                                <li>Ubicación en Google Maps</li>
                                <li>Publicaciones de productos o servicios en Facebook</li>
                                <li>Publicidad de productos o servicios en Facebook</li>
                            </ul>

                            <h4>Características específicas</h4>
                            <ul>
                                    <li>Diseño del logo de los perfiles (opcional)</li>
                                    <li>1 actualizaciones mensuales de la infomación de contacto</li>
                                    <li>2 publicaciones mensuales del contenido (texto, imagenes , links)</li>
                                    <li>Estadísticas de rendimiento y alcance (Facebook Ads)</li>
                                    <li>Tiempo de entrega: 7 - 15 días laborales</li>
                            </ul>
                        </div>
                        <!-- inversion -->
                        <div class="section-b">
                            <h2 class="pb-3" id="inversion"><i class="fal fa-file-invoice-dollar social"></i> Condiciones de pago del <strong><span class="tecnicoa">Plan</span> <span class="social">SOCIAL</span></strong></h2>
                            <div class="row pb-5">
                                <div class="col-sm-12 col-md-4 text-center">
                                    <div class="card shadow-pricing mb-4">
                                        <div class="card-header text-white bg-site-social">Primer mensualidad</div>
                                        <div class="card-body plans-price">
                                            <p>US $32.99</p>
                                            <small>(₡ 19,794.88)</small>
                                        </div>
                                    </div>
                                </div>
                                <div class="col">
                                    <h5 class="mt-0">Inversión inicial:</h5>
                                    <p>La inversión inicial de <strong>US $32.99</strong> incluye todas las características indicadas para este plan. ¡No existe ningún otro costo oculto!</p>
                                    <h5 class="mt-4">Condiciones de pago:</h5>
                                    <ul>
                                        <li>Pago de contado: <strong>US $32.99</strong> para iniciar el proceso.</li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <!-- metodos de pago -->
                        <div class="section-b">
                            <h2 class="pb-3" id="pago"><i class="fal fa-money-check-alt social"></i> Métodos de pago</h2>
                        ...
                        <!-- dominio --
                        <div class="section-b">
                            <h2 class="pb-3" id="dominio"><i class="fal fa-globe-americas social"></i> Nosotros nos encargamos de encontrar el nombre de dominio por usted</h2>
				...
				<p>En <strong><span class="tecnicoa">Tecnicoa</span><span class="CR">CR</span>&reg;</strong> el costo y la configuración del dominio (.com) están incluidos en nuestros planes de desarrollo web. Otros dominios pueden ser utilizados pero el costo del mismo no está incluido.</p>
                        ...
                        <div class="section section-b" id="formulario">
                            <h2 class="pb-3" id="comprar"><i class="fal fa-shopping-cart CR"></i> Contratar <strong><span class="tecnicoa">Plan</span> <span class="CR">PRO</span></strong></h2>
                            <div class="text-justify pb-4">
                            ...
                            <div class="shadow-d-md bg-white border-t-5 border-blue rounded-br">
                                <form id="solicitarPlan" novalidate name="need-plan-pro" action="<?php $_SERVER['PHP_SELF'] ?>" method="POST" enctype="multipart/form-data" autocomplete="off">
                                    <fieldset class="pb-4">
                                        <legend>Información del  <span class="CR"><strong><span class="tecnicoa">Plan</span> <span class="tecnicoa">PRO</span></strong></span></legend>
                                            <div class="form-row">
                                                <div class="form-group col-md-6 col-lg-4">
                                                    <label for="inputPaquete">Plan </label>
                                                    <input class="form-control" id="inputPaquete" name="inputPaquete" value="PRO" readonly required>
						</div>
                                                <div class="form-group col-md-6 col-lg-4">
                                                    <label for="inputPagoInicial">Pago inicial (US$)</label>
                                                    <input class="form-control" id="inputPagoInicial" name="inputPagoInicial" value="44.99" readonly required>
						</div>
                                              
                                                <div class="form-group col-md-6 col-lg-4">
                                                    <label for="inputAnualidad">Anualidad (US$)</label>
                                                    <input class="form-control" id="inputAnualidad" name="inputAnualidad" value="539.88" readonly required>
						</div>
                                                <div class="form-group col-md-6 col-lg-4">
