...
<html>
	...
	<title>Software | TecnicoaCR</title>
		
	<!-- Metatags
	================================================== -->
	<meta name="description" content="Aplicaciones desarrolladas por TecnicoaCR" />
	<meta name="keywords" content="apps, aplicaciones,software, php, programacion, TecnicoaCR, nicoya, guanacaste, costa rica" />
	<meta property="og:title" content="Aplicaciones desarrolladas por TecnicoaCR | Costa Rica" />
	<meta property="og:description" content="Aplicaciones desarrolladas por TecnicoaCR" />
	...
	<link rel="canonical" href="../index.php" />
        <link rel="alternate" hreflang="en" href="../apps/index.php" />
	...
	<main>
                    ...
                    <div class="hero-message">
                        <div class="row">
                            <div class="col-md-12 col-lg-7 pr-5">
                                <h1><small>Aplicaciones de </small> Tecnicoa<span class="CR"><strong>CR</strong></span> </h1>
                                <p>Nuestros desarrollos a nivel de programación web abarcan la creación de sitios web para Internet o una intranet. Para conseguirlo, hacemos uso de tecnologías de software del lado del servidor(BackEnd) y del cliente(FrontEnd) que involucran una combinación de procesos de base de datos con el uso de un navegador web con la finalidad de realizar determinadas tareas y analizar la información.</p>
                                <div id="more">
                                    <a class="btn-cta btn-cta-orange" href="#apps"><i class="fal fa-chevron-circle-down"></i> Ver aplicaciones</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="section-white-wave">
                    <div class="container">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-md-12 col-lg-6" id="apps">
                                <p class="text-center lead pb-5"></p>
                            </div>
                        </div>

                        <h2 class="h2 text-center pb-1" >Nuestras <strong>Aplicaciones</strong></h2>
                        </div>
                </div>
            </div>
            ...
            <!-- Apps
            ================================================== -->
            <div class="container section-b" style="margin-top: -120px;">
                <div class="row justify-content-center">
                    <div class="col-md-6 col-lg-4 d-flex align-items-stretch pb-5">
                        <div class="shadow-box bg-white border-t-5 border-red rounded-br-lg">
                            <div class="blog-info thumb">
                                <a>
                                    <img src="../assets/img/content/sistema-cctv-tecnicoacr.jpg" class="img-fluid" width="580" height="420" alt="Sistema de cctv de TecnicoaCR">
                                    <h3>TecOS_MyCCTV</h3>
                                </a>
                                <p>Gestione facilmente sus diferentes videograbadores gracias a esta poderosa aplicacion</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-4 d-flex align-items-stretch pb-5">
                        <div class="shadow-box bg-white border-t-5 border-red rounded-br-lg">
                            <div class="blog-info thumb">
                                <a>
                                    <img src="../assets/img/content/sistema-certificacion-tecnicoa.jpg" class="img-fluid" width="200" height="320" alt="Sistema de Certificaciones de TecnicoaCR">
                                    <h3>TecOS_Cert</h3>
                                </a>
                                <p>Gestión de certificados de participación digitales</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-4 d-flex align-items-stretch pb-5">
	...
	<script>$(document).ready(function(){var $root=$("html, body");$("#sidebar a").click(function(t){t.preventDefault();var r=$.attr(this,"href"),o=$(r).offset().top-115;return $root.animate({scrollTop:o},1e3),!1});})</script>
