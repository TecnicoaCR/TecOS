		...
		<div id="services" class="container section-y">		
			...
			<div class="row justify-content-center">
				...
				<div class="row justify-content-center" style="margin-top: -30px;">
					<div  style="margin-top: -30px;" class="col-md-6 col-lg-4 d-flex align-items-stretch wow zoomIn mb-2" data-wow-duration="1500ms" data-wow-delay="100ms">
					...
					<div style="margin-top: -40px;" class="col-md-6 col-lg-4 d-flex align-items-stretch wow zoomIn mb-2" data-wow-duration="2000ms" data-wow-delay="200ms">
						<div class="shadow-d-sm shadow-box rounded-br mb-5">
							<div class="thumb">
					...
					<div  style="margin-top: -40px;" class="col-md-6 col-lg-4 d-flex align-items-stretch wow zoomIn mb-2" data-wow-duration="2500ms" data-wow-delay="300ms">
						<div class="shadow-d-sm shadow-box rounded-br mb-5">
							<div class="thumb">
